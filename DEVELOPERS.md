...
This list is regenerated by [`./bootstrap.sh`](bootstrap.sh) from the `src/` tree — do not
edit it by hand, run `./bootstrap.sh` instead after adding or removing a piece.
<!-- LYINIT:MAKE-COMMANDS:BEGIN -->
```
...
make -C src/carl-philipp-emanuel-bach/solfeggio-H.220
...
make -C src/domenico-scarlatti/sonata-k141
...
make -C src/hans-erich-apostel/kubiniana-op.13
...
make -C src/johannes-brahms/klavierstucke-op.118
...
make -C src/johann-sebastian-bach/cantatas/cantata-BWV106-actus-tragicus-sonatina
make -C src/johann-sebastian-bach/cantatas/cantata-BWV54-aria
make -C src/johann-sebastian-bach/cembalo-konzert-largo-BWV1056-kempff
make -C src/johann-sebastian-bach/chaconne-fur-violine-BWV1004-busoni
...
make -C src/johann-sebastian-bach/das-wohltemperierte-klavier-I
...
make -C src/johann-sebastian-bach/praeludium-und-fughetta-BWV899
...
make -C src/rued-langgaard/insektarium-BVN134
```
<!-- LYINIT:MAKE-COMMANDS:END -->
