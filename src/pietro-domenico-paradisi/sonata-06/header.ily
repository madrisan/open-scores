\header {
  composer = "Pietro Domenico Paradisi (1707-1791)"
  date = "1754"

  footer = "Mutopia-2025/06/13"

  lastupdated = "2025 June 13"
  license = "Creative Commons Attribution Non Commercial Share Alike 4.0 International"
  maintainerEmail = "d.madrisan@proton.me"
  maintainerWeb = "https://github.com/madrisan/open-scores"

  % Extra Mutopia Information
  mutopiacomposer = "ParadisiPD"
  mutopiacopyright = "Creative Commons Attribution Non Commercial Share Alike 4.0 International"
  mutopiainstrument = "Clavicembalo"
  mutopiamaintainer = "Davide Madrisan"
  mutopiaopus = "P893.06"
  mutopiatitle = "Allegro (Toccata) dalla Sonata no. 6 in La Maggiore"

  opus = "P893.06"
  title = "Allegro (Toccata) dalla Sonata no. 6 in La Maggiore"
  source = "Alphonse Leduc, Paris"
  style = "Stile galante"
