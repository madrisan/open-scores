...
extendLV = #(define-music-function (parser location further) (number?) #{
  ...
  \once \override LaissezVibrerTie.extra-offset = #(cons (/ further 2) 2.5)
#})
...
Sopran = \context Voice = "one" \relative c'' {
  ...
  | f c ) c8\rest c^.
  | c16[ ( g16^.] ) g[ ( a] bes8 d
  | c8 a \autoBeamOff g ) a ( \autoBeamOn
  %15
  | bes[\<  e a\! g]
  | fis[ cis e d]
...
Alto = \context Voice = "two" \relative c'' {
  ...
  | a <e g> cis' <g a> fis' <g, a> e' <g, a>
  %10
  | cis_\> <cis, g'> b' <d, g>\! a' [<dis, g>]
    a'_\markup { \hspace #-2 "(" \dynamic pp ")" } [<e g>]
...
Tenor = \context Voice = "three" \relative c {
  ...
  \partial 8
    r8
  %1
  | <a, a'>8_.\p \dynamicUp r8 r8 cis'8 (
  | \once\override Hairpin.shorten-pair = #'(1 . -2)
    d[_\< fis b\! a] )
  | a,16[ a'] a8~ \autoBeamOff a8 a,~ \autoBeamOn
  | a2
  %5
  | \grace { a,8 ( } a'8[_\< ) ( cis fis e\!]
  | <d, d'>4. ) <c c'>8_\(
  | <b b'>4. <bes bes'>8
  | <a a'>[ <b b'> <bis bis'> \tieNeutral <cis cis'>~ ]
  | <cis cis'> a \) r8
    \extendLV #0.8
    \once\override LaissezVibrerTie.extra-spacing-height = #'(0 . 5)
    cis'^\laissezVibrer
  %10
  | <a, a'>[_\( <b! b'!> <cis cis'> <c c'>~_> \)]
  | <c c'>4. e'8 (
  | f8\< [ a d\! c ] )
...
Bass = \context Voice = "four" \relative c {
  ...
  %15
  | s2*3
  | a8 a,8 d4_\markup { \hspace #3 "D.C." }
  \fine
}
