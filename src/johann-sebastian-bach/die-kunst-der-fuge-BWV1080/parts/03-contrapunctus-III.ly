...
Soprano = \context Voice = "one" \relative c'' {
  ...
  | c b ees4 c4. d8
  | g,4 c2 b8 bes~
  | bes a \highlightSubjectInv { a'2^\markup \scale #'(1 . -1) \subject #'(2.5 . 0) #1 d,4~
  | d8 e f4~ f8 g a4~
  %25
  | a8 g bes2 a8 g
  | f2~ f8 e fis g
...
Alto = \context Voice = "two" \relative c' {
  ...
  %5
  | \stemUp
    \highlightSubjectInv { a'2^\markup \scale #'(1 . -1) \subject #'(0 . 0) #1 d,
  | f a
  | bes a4 g
  | f2~ f8 e f g
  | \stemDown
  ...
  | d~ d8 cis d e
  %55
  | \highlightSubjectInv { a,2_\markup \scale #'(1 . -1) \subject #'(0 . 0) #1 d,4. e8
  | f!4. g8 a4. g8
  | bes2~ bes8 a4 g8
  | f2~ f8 e fis gis
...
Tenor = \context Voice = "three" \relative c' {
  ...
  | R1
  | s1*9
  | r4 \highlightSubjectInv { e'2^\markup \scale #'(1 . -1) \subject #'(2.5 . 0) #1 a,4~
  %30
  | a8 b c4~ c8 d e4~
  | e8 d
    \change Staff = "upper"
  ...
  | d2~ d8 g, a bes!
  %35
  | c bes \highlightSubjectInv { c2^\markup \scale #'(1 . -1) \subject #'(2.5 . 0) #1 f,4~
  | f8 g a4~ a8 bes c4~
  | c8 bes d2 c8 bes
  | a2~ a8 g a b
  ...
  | \override MultiMeasureRest.staff-position = #6
    R1
  | \highlightSubjectInv { a,2^\markup \scale #'(1 . -1) \subject #'(2.5 . 0) #1 d,
  | f a
  %65
  | bes! a4 g
  | f2~ f8 e fis g
...
Bass = \context Voice = "four" \relative c {
  ...
  | s1*14 %1 to 14
  %15
  | \highlightSubjectInv { a'2_\markup \scale #'(1 . -1) \subject #'(0 . 0) #1 d,
  | f a
  | bes a4 g
  | f2~ f8 e f g
  ...
  | s1*3
  %51
  | \highlightSubjectInv { c2_\markup \scale #'(1 . -1) \subject #'(1.5 . 0) #1 g
  | bes d
  | ees d4 c
  | bes2~ bes8 a b cis
  %55
