...
Soprano = \context Voice = "one" \relative c'' {
  ...
  %1
  | s1*4
  | \voiceOne r4 \highlightSubject { as8 ees' c[ as] f' des
  | \unHighlightSubject es2~ } es4 as~
  | as4 g f2~
  ...
  | d8 bes es2 d4
  | es4 r r2
  | r4 \highlightSubject { as,8 es'  c as ges' es
  %25
  | \unHighlightSubject f4~ } f8 g!  es4~ es8 f
  | des4~ des8 bes'  c, des16 bes c8 as'
  | bes,4  r16 es f g  as4~  as16 g f as
  | g2.~ g8 f~
  | f16 es d f  es2 des4~
  %30
  | des16 c bes des  \highlightSubject { c8 f  des[ bes] ges' es8
  | f4 } as8 f  g!4 bes8 g
  | as8 f des!4~  des8[ es] c f
  | c4 bes~  bes8 as16 g  \highlightSubject { as8 es'
  | c8 as f' des  \unHighlightSubject es } g, as4~
  %35
...
Alto = \context Voice = "two" \relative c' {
  ...
  %1
  | s1*5
  | \voiceTwo r4 \highlightSubject { es8 as  g es c' as
  | \unHighlightSubject bes4~ } bes16 es, f g as bes c bes as g f as
  | g2 f
  | r16 es f g  as2 g4
  %10
  | as8 g16 f  es des c d  es8 d\rest 
    \once\override Voice.Rest.X-offset = #-0.5 d4\rest
  | as'8 r s2.
  | s1
  | r4 \highlightSubject { f8 c'  as f des'! bes
  | \unHighlightSubject c8 } d16 e  f8 c  des bes es bes
  %15
  | c8 as des as  bes16 c des c  bes as g bes
  | as4 e\rest c2\rest
  | r4 \highlightSubject { bes8 f'  des bes ges' es }
  | r4 \highlightSubject { f8 bes  ges es c' a!
  ...
  | g16 as bes g  \highlightSubject { es8 bes'  g es des'! bes
  ...
  | g8 r \highlightSubject { es as  f des! bes' g
  %30
  | as4 } d,\rest d\rest b'8\rest 
    \once\override NoteColumn.force-hshift = #0
    \once\omit Flag \once\omit Stem \highlightSubject { \unHighlightSubject es~ }
...
Tenor = \context Voice = "three" \relative c' {
  ...
  %1
  | \change Staff = "upper"
    r4 \highlightSubject { as8 es'  c[ as f' des]
  | \unHighlightSubject es4~ }  es16 des c des  es f g es  as bes c bes
  | as16 g f as  g2 f4~
  | f16 es d f  es4.  des16 c  des f bes as
  %5
  | \voiceFour g16 f es des  
    \showStaffSwitch
  ...
  | s1*2
  %10
  | r4 \highlightSubject { as8 es'  c as
    \change Staff = "upper" \voiceTwo
  ...
  | \voiceThree es16 des c bes  \highlightSubject { \unHighlightSubject as8 } r r2
  | r4 \highlightSubject { g'8 c  as f d' b
  | \unHighlightSubject c16 } es,! f g  as bes! c bes  as g f g  as g f es
  %30
...
Bass = \context Voice = "four" \relative c {
  ...
  %1
  | R1
  | r4 \highlightSubject { es8 as  g es c' as
  | \unHighlightSubject bes8 } es, bes' g  as[ es as f]
  | g4~  g16 c, des! es  f g as f  bes c des c
  %5
  | bes16 as g bes as4_~ as16 as, bes c \voiceFour des es f es
