  ...
  \markup {
    \fill-line {
      \center-column {
        ...
        \null\null\null
        \line { \abs-fontsize #24 \bold "Praeludium und Fuga II" }
        \null
        \line { \abs-fontsize #24 \bold "(c-Moll)" }
        \null\null
        \line { \abs-fontsize #21 "BWV 847" }
        \null\null\null\null
  ...
  \markup {
    \fill-line {
      \center-column {
        \null\null\null\null
        \fill-line {
          \abs-fontsize #10 "Based on: Based on: Carl Czerny - Leipzig @source@ Berline: C.F. Peters"
        }
        \null\null
      }
    }
