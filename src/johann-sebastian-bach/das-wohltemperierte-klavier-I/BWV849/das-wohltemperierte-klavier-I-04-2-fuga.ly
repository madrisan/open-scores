...
Mezzosoprano = \context Voice = "two" \relative c'' {
  ...
  | \change Staff = "upper" \stemDown\tieDown
    \once\override Voice.Rest.X-offset = #1.4 g'4\rest
    gis cis cis
...
Alto = \context Voice = "three" \relative c' {
  ...
  %1
  | R1*6
  | e2\rest \highlightSubject { cis
  | bis e
  | dis1 }
  %10
  | cis2 \tieDown fis~
  | \stemDown fis4 e dis cis
  | cis2 b
  | cis fis~
  | fis4 e dis cis
  %15
  ...
  | e2 e\rest
  | R1*2
  | e2\rest \highlightSubject { \stemDown gis
  | fisis b
  %40
  ...
  | e4\rest b e e
  | e d8 cis b4 f'\rest
  | \change Staff = "upper" \stemDown f,\rest cis' fis fis
  | fis e8 dis e2
  | \once\override Tie.extra-offset = #'(0 . -1)
    fis2.~ fis8 gis
  %100
  | a4 gis8 fis gis4 fis8 e
  | dis2 \once\omit Stem \highlightSubject { e~
  | e dis4 } cis
