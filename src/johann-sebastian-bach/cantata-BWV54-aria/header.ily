\header {
  ...
  mutopiaopus = "BWV 54"
  mutopiatitle = "Cantata Widerstehe doch der Sünde (Aria) Es-Dur"

  opus = "BWV 54"
  title = "Cantata Widerstehe doch der Sünde (Aria) Es-Dur"
  source = "Nuno R. Rodrigues"
  style = "Baroque"
