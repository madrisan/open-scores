...
QuiZi = \markup \center-column {
  ...
  \combine \move-markup \concat {
    "B" \with-color #(x11-color 'darkgreen) \concat { "/C" \raise #0.6 \text-flat } } #Dur-radius #150
  \combine \move-markup \concat {
    \with-color #(x11-color 'darkgreen) \concat { "G" \raise #0.6 \text-flat } \concat { "/F" \text-sharp } } #Dur-radius #180
  \combine \move-markup \concat {
    \with-color #(x11-color 'darkgreen) \concat { "D" \raise #0.6 \text-flat } \concat { "/C" \text-sharp } } #Dur-radius #210
  \with-color #(x11-color 'darkgreen)
  \combine \move-markup \concat { "A" \raise #0.6 \text-flat } #Dur-radius #240
  \combine \move-markup \concat { "E" \raise #0.6 \text-flat } #Dur-radius #270
  \combine \move-markup \concat { "B" \raise #0.6 \text-flat } #Dur-radius #300
  ...
  \combine \move-markup \concat { "f" \text-sharp } #moll-radius #90
  \combine \move-markup \concat { "c" \text-sharp } #moll-radius #120
  \combine \move-markup \concat {
    \concat { "g" \text-sharp } \with-color #(x11-color 'forestgreen) \concat { "/a" \raise #0.6 \text-flat } } #moll-radius #150
  \combine \move-markup \concat {
    \with-color #(x11-color 'forestgreen) \concat { "e" \raise #0.6 \text-flat } \concat { "/d" \text-sharp } } #moll-radius #180
  \combine \move-markup \concat {
    \with-color #(x11-color 'forestgreen) \concat { "b" \raise #0.6 \text-flat } \concat { "/a" \text-sharp } } #moll-radius #210
