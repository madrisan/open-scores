...
VoiceTwo = \context Voice = "two" \relative c {
  ...
  | a16[ d, e fis] g[ e fis d] \clef "treble" a'8_.[ d_. c d]
  | g,16[ g' f e] d[ f e g] f8_.[ e_. f d]
  %10
  | e16[ a g f] e[ g f a] g8_.[ f_. g e]
  | f16[ bes_2 a_3 g] f[ a g bes_2] a_1[ g f e] d[ f e g_2]
  | f_1[ e d c] b[ d c e_2] d_1[ c b a] gis[ b a c_2]
  | \clef "bass"
  | b8^._1[ e,^.] d'8._2[^\mordent e16] c_2[ b_3 a_1 g!] fis[ a gis_4 b]
  %15
