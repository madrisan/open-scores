...
Soprano = \context Voice = "one" \relative c'' {
  ...
  | b2\trill \unHighlightSubject a16 } b c d e a, e' fis
  %5
  ...
  | \highlightSubjectFirst { a8 b c a e'4 e8\rest a,
  ...
  | \override MultiMeasureRest.staff-position = #2
    R1*4
  %41
  | \highlightSubjectSecond { e4\rest e dis d
  | cis c b } bes
  | a d2 cis4
  ...
  %55
  | R1
  | r2 \highlightSubjectSecond { r4 e
  | dis d cis c
  | b } e2 dis4
  ...
  | \override MultiMeasureRest.staff-position = #2
  | R1*2
  | r2 \highlightSubjectFirst { a,8 b c a
  %75
  | d4 d8\rest a f'4 f8\rest a,
  | e'4 f16\rest d cis b! a b c a d8 d
  | d8 c16 b d c b a b2~
  | b8 gis \unHighlightSubject a4~ } a16 b c8~ c16 a fis b
...
Alto = \context Voice = "two" \relative c' {
  ...
  | fis2\trill \unHighlightSubject e16 } fis g a b e, b' cis
  ...
  | s1*16
  %33
  | \highlightSubjectFirst { \unHighlightSubject a4 } e16\rest a g f g4~ g16 f e g
  | f4~ f16 e f d gis4 f\rest
  %35
  | c\rest e16\rest c' b a gis b e,8~ e d16 c
  | f8 e\rest e d d c c4\rest
  | \highlightSubjectSecond { d\rest e dis d
  | cis c b } e~
  ...
  | g8 e
    ...
    cis
    \change Staff = "upper" \stemDown \unHighlightSubject
    ais' b fis~ fis16 e d g! \showStaffSwitch
  | e8 cis dis16 e fis8~ fis16 e b d cis d e8~
  | e16 d a c!
    \change Staff = "lower" \stemUp
    b g b
    \hideStaffSwitch \change Staff = "upper" \stemDown
    \unHighlightSubject d g a bes8~ bes16 g e a \showStaffSwitch
  | f8
    \hideStaffSwitch \change Staff = "lower" \stemUp
    d b!
    \hideStaffSwitch \change Staff = "upper" \stemDown
  ...
  | a
    ...
    g' c!16 d ees8~ ees16 c a d \showStaffSwitch
  | g,4 e\rest e2\rest
  | \highlightSubjectSecond { g4\rest g fis f
  %50
  | \showStaffSwitch \change Staff = "lower" \stemUp
    e ees
    \change Staff = "upper" \stemDown
    \unHighlightSubject d8 }
    g16 fis g4~
  | g f e8 a16 gis a4~
  | a g fis2
  | e~ e16
  ...
  | dis, e fis8 e e\rest \highlightSubjectSecond { e4\rest a
  | gis g fis f
  %60
  | e4 } a2 gis!4
  | a4 s2.
  | s4 \once\stemUp \highlightSubjectSecond { a gis g
  | fis f e } a~
  | a gis a8. g16 fis4~
  %65
  ...
  %70
  | \once\stemUp a \highlightSubjectFirst { \unHighlightSubject g16 } f e d
    cis b cis \highlightSubjectFirst { \unHighlightSubject e } a,8 a\rest
  | d'16\rest \stemUp g, a bes a g e' g, f2
  | e8 e a a a4 c8\rest gis
  | a4 b~ b16 e, fis gis a8 a
  | a g^~ g f16 e \stemDown f a g f e g f e
  %75
  | d4 d\rest \highlightSubjectSecond { d\rest a'
  | gis g fis f
  | e } a2 gis8. b16
...
Tenor = \context Voice = "three" \relative c' {
 ...
 %1
  | R1*9
  %10
  | r2 \highlightSubjectFirst { a8 b c a
  | e'4 r8 a, f'4 r8 a,
  | e'4 e16\rest d c b a b c a d8 d
  | d c16 b d c b a b2\trill
  | \unHighlightSubject a16 } e a b c a c d e4~ e16 d c b
  %15
  ...
  | d,4~ d16 f e d c2
  %25
  | b4 b\rest \highlightSubjectFirst { a8 b c a
  ...
  | d c16 b d16 c b a
    ...
    b2_\trill
  | \change Staff = "lower" \stemUp
    \unHighlightSubject a16 } e a b c a c \showStaffSwitch d
    \change Staff = "upper" \stemDown
    e2~
  %30
  | e16
  ...
  | \override MultiMeasureRest.staff-position = #5
    R1*5
  %42
  | \highlightSubjectSecond { f4\rest a, gis g
  | fis \once\stemDown f e } a~
  | \stemDown a gis \stemUp a16 b c8~ c16 a fis b
  %45
  | g8 e cis a' \stemUp d16 e f8~ f16 d b e
  | \stemDown c!8 a fis dis' e4. cis8 \stemUp
  ...
  | \once\override MultiMeasureRest.staff-position = #8
    R1
  | R1*2
  | r2 \highlightSubjectSecond { c,4\rest d!
  %55
  | cis c b bes
  | a } d~ d16 c b d c4~
  ...
  | R1
  %65
  | s2 e'16\rest a, b cis \highlightSubjectSecond { d!4
  | cis c b bes
  | a } d2 cis4
...
Bass = \context Voice = "four" \relative c {
  ...
  %1
  | R1*13
  | r2 \highlightSubjectFirst { e8 fis g e
  %15
  ...
  | \stemNeutral\tieNeutral
    ...
    \unHighlightSubject e8 } g, a b e,16 b' e d cis d b cis
  | d e d c b c a b c d c b a b gis a
  %20
  | b c b a gis a fis gis a8 b c a
  | e' e, e' d c d e c
  | g' g, g' fis \highlightSubjectFirst { e fis g e
  | b'4 r8 e, c'!4 r8 e,
  | b'4 r16 a gis fis e fis gis e a8 a
  %25
  | a8 g16 fis a g fis e fis2\trill
  | \unHighlightSubject e8 } d! cis4 d8 d, d'4~
  ...
  | d b\rest e b\rest a \highlightSubjectSecond { b\rest a'4
  | gis g fis f
  | e } a2 gis4
  ...
  | R1*4
  %47
  | r2 \highlightSubjectSecond { e'4\rest c'
  | b bes a aes
  | \clef bass g } c2 b4
  %50
