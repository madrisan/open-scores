\header {
  ...
  footer = "Mutopia-2025/07/15"

  lastupdated = "2025 July 15"
  ...
  mutopiaopus = "BWV 950"
  mutopiatitle = "Fuga A-Dur Über ein Thema von Tommaso Albinoni"

  opus = "BWV 950"
  title = "Fuga A-Dur Über ein Thema von Tommaso Albinoni"
  source = "Bach-Gesellschaft Ausgabe - Leipzig: Breitkopf und Härtel, 1890"
  style = "Baroque"
