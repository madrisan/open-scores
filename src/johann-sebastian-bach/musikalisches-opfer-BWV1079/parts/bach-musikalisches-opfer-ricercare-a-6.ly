...
VoiceTwo = \context Voice = "two" \relative c'' {
  ...
  | \once\shape #'(((0 . 0) (0 . -0.8) (0 . -0.8) (0 . 0))) Tie
    g1~
  | \hshift #-0.4 g4 f \hshift #0.3 f'2~
  %70
...
VoiceThree = \context Voice = "three" \relative c' {
  ...
  | \override MultiMeasureRest.staff-position = #-6
    R1*2
  | \hshiftRest #-1 c4\rest \hshift #-0.5 d2 c8 d
  | ees1
  %55
  | d2. c4
  | d c8 d ees4 d8 c
  ...
  | f2 c\rest
  | c4\rest
    \stemDown \override Stem.length = #4
    f4 d bes
  %125
  | des2 c\rest
  | b4\rest ees c aes
