\header {
  ...
  footer = "Mutopia-2025/07/25"

  lastupdated = "2025 July 25"
  ...
  mutopiaopus = "BWV 898"
  mutopiatitle = "Präludium und Fuge über den Namen BACH"

  opus = "BWV 898"
  title = "Präludium und Fuge über den Namen BACH"
  source = "Marijn Hartkamp publisher"
  style = "Baroque"
