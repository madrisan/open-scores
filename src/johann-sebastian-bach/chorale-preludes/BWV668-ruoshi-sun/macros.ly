...
cantusFirmusInvColor = #(x11-color 'royalblue)
cantusFirmusOrnColor = #(x11-color 'darkred)
...
#(define-music-function (music)
   ...
   #{ \markWithColorExtended \cantusFirmusInvColor #music #})

highlightCFOrn =
#(define-music-function (music)
   (ly:music?)
   "Colour the given note(s) to highlight fugues (first) inverted subjets"
   #{ \markWithColorExtended \cantusFirmusOrnColor #music #})
