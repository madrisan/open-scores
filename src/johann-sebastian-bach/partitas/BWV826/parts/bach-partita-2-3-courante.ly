...
Soprano = \context Voice = "one" \relative c'' {
  ...
  \partial 8 c8
  %1
  | c4~ c16 g a b c8 d ees c aes'4. aes8
  | g1~ g4 f~
  | f16 aes g f g8 d ees2~ ees8 ees d c
  ...
  | bes aes g f ees4 d8.\prallprall ees16 f2~
  %20
...
Alto = \context Voice = "two" \relative c' {
  ...
  | b2~ b8 b c4 \once\override Voice.Rest.X-offset = #1.4 b\rest a
