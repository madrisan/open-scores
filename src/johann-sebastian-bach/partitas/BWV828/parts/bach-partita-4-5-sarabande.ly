...
Soprano = \context Voice = "one" \relative c'' {
  ...
  | \stemUp gis32 fis e16 d' b \stemDown gis e \staffLower\stemUp b gis
    \set subdivideBeams = ##t
    e fis32 gis a b cis d
    \set subdivideBeams = ##f
  | \staffUpper cis32 e a8 gis16
    \set subdivideBeams = ##t
    a16 e32 a cis b a gis a16 e32 a cis b a gis
    \set subdivideBeams = ##f
  %10
  | \stemNeutral a32 cis d8 cis16
    \set subdivideBeams = ##t
    d16 a32 d fis e d cis d16 a32 d fis e d cis
  | d32 fis e d cis b cis e a16 gis32 fis e d cis b
    \set subdivideBeams = ##f
    cis16 a e gis
  ...
  | %\once\override TupletNumber.extra-offset = #'(0 . -8)
    ...
    \tuplet 6/4 {
      \staffLower\stemUp ais,16[ b cis \staffUpper\stemDown d] e[ fis]
    }
    \stemDown e'2
  %15
  ...
  | \set subdivideBeams = ##t
    g fis e16~ e32 b e fis
    g fis e d! cis b ais gis
    ais cis e8 g,16
  ...
  | g a, gis a b cis d e
    \set subdivideBeams = ##f
    fis16 c32 b c16 g' a c, b a
  | \set subdivideBeams = ##t
    b32 g fis g a b cis! d
    \set subdivideBeams = ##f
    cis16 g32 fis g16 d' e g, fis e
  | \stemUp\tieDown
    \set subdivideBeams = ##t
    fis32 a b cis d cis d16~ d32 gis a b a gis fis e
    \set subdivideBeams = ##f
    d cis d16 b' d,
  | d cis8.^~
    \set subdivideBeams = ##t
    cis32 d e d cis d cis b
    \set subdivideBeams = ##f
    b16 a8.
