...
Soprano = \context Voice = "one" \relative c' {
  ...
  | fis16 c' b a b g e'8~ e16 d cis b a g32 fis g16 e'
  | g,4 fis_~\prall fis16 a b cis d cis b a
  %5
  ...
  %10
  | d16 gis32 a b8~ b16 a gis fis \tuplet 3/2 { e16 d cis } d8~ \tupletSpan 8 \tuplet 3/2 { d16 cis b fis' e d }
  | cis16 a gis a a cis8.~ cis16 d32 e d16 cis cis16 d32 e d16 cis
  | c16 fis32 gis a8~ a16 gis fis e \tuplet 3/2 { dis16 cis b } c8~ \tuplet 3/2 { c16 b a c b a }
  | a16 gis8.~ gis8~ gis32 dis'32 e fis  e16 dis dis e e gis a c
  | e,32 f g! f e f e d~ d8~ d32 cis d e d16 cis cis d d e gis b
  %15
  | d,32 e f e d e d c~ c8~ c32 b c d c16 b b c c fis32 gis a16 c,~
  | \stemUp\tieUp \tupletSpan 8 \tuplet 3/2 { c b a b a gis f'e d e d c a' gis fis gis fis e c' b a b a gis~ }
  ...
  | \tuplet 3/2 { d cis b cis b a d c b c b a } c16 dis,8 e16~ \tuplet 3/2 { e16 a b c b a }
  | f'16 gis,8 a16~ \tuplet 3/2 { a16 d e f e d gis d e f e d a' d, e f e d }
  | b'32 f e d e16 b c gis a dis,~ dis32 e fis! gis a b cis d~ d16 b gis a
  ...
  | a'4~ a16 g fis e d b cis e~ e d cis b~
  | \stemNeutral\tieNeutral b16 a cis d~ d cis32 b fis'16 g~ g e32 fis g a b16~ b32 a g fis g16 e
  | e4\prall fis4~\mordent fis16 fis fis32\prall e fis16 a b, c8~
  ...
  | e32 dis cis b a'16 g~ g fis32 e d16 cis \tuplet 3/2 { d16 cis b } g'16 fis~ fis e32 d cis d e16
  | b8 ais~ \tupletSpan 8 ais8~ ais32 eis' fis gis fis16 eis eis fis fis ais ais b
  | fis32 g! a! g fis g fis e~ e8~ e32 dis e fis e16 dis dis e e ais ais b
  | e,32 fis g fis e fis e d!~ d8~ d32 cis d e d16 cis cis d d gis32 ais b16 d,~
  %35
  | \tupletSpan 8 \tuplet 3/2 { d16 cis b cis b ais } ais16 g'8.~ \tuplet 3/2 { g16 fis e fis e dis } dis16 c'8.~
  ...
  | \tuplet 3/2 { a16 fis g a g fis } fis16 g8.~ g16 a32 b a16 g g a32 b a16 g
  %45
  | g16 cis32 d e8~ e16 d cis b a g32 fis g8~ \tuplet 3/2 { g16 fis e b' a g }
  | fis16 d cis d d fis8.~ fis16 g32 a g16 fis fis g32 a g16 fis
  | f16 b32 cis d8~ d16 cis b a \tuplet 3/2 { gis16 fis e } f8~ \tuplet 3/2 { f16 e d f e d
  | cis16 b a } g'8~ \tuplet 3/2 { g16 f e f e d e d cis } bes'8~ \tuplet 3/2 { bes16 a g a g f
  | g f e } d'8~ \tuplet 3/2 { d16 cis b cis b a g' fis! e fis e d } a'16 c,8.~
  %50
  ...
  | e'32 bes a g a16 e f cis d gis,~ gis32 a b! cis d e fis g~ \tuplet 3/2 { g16 fis e fis e d }
  %55
  | d32 fis e d c'8~ c16 b32 a b16 e~ e32 d cis b a d gis,16~
