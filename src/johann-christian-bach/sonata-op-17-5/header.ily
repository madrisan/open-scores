\header {
  ...
  footer = "Mutopia-2025/08/01"

  lastupdated = "2025 August 01"
  license = "Creative Commons Attribution Non Commercial Share Alike 4.0 International"
  maintainerEmail = "d.madrisan@proton.me"
  maintainerWeb = "https://github.com/madrisan/open-scores"

  % Extra Mutopia Information
  mutopiacomposer = "BachJC"
  ...
  mutopiaopus = "W. A11"
  mutopiatitle = "Six Sonatas for the Harpsichord or Piano Forte"

  opus = "W. A11"
  title = "Six Sonatas for the Harpsichord or Piano Forte"
  source = "Leipzig: C.F. Peters, 1927"
  style = "Classical"
